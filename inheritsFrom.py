...
with open('data/inheritsFrom/fcg_output_inheritsFrom.json', 'w') as outfile:
...
for output in fcg_output_list:
    if output.get("frameSet") is not None and output["frameSet"] is not None:
        ...
        for frame in frame_set:
            ...
            SELECT DISTINCT ?frame ?inheritsFromFrame
            WHERE {{
                ?frame a tbox:Frame ;
                    tbox:inheritsFrom ?inheritsFromFrame ;
...
with open('data/inheritsFrom/inheritsFrom.json', 'w') as f:
